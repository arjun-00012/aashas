...
class ProductFourPhotoAndLookbookTests(TestCase):
    ...
    def test_index_page_renders_oldtheory_style_spotlights_and_collections(self):
        ...
        self.assertContains(resp, 'collectives_1.jpg')
        self.assertContains(resp, 'collectives_2.jpg')
        self.assertContains(resp, 'collectives_3.jpg')
        self.assertContains(resp, 'collectives_4.jpg')
